...
                    </button>
                    
                    {/* UPDATED: Changed "My Listings" to "Car Listing" */}
                    <button onClick={() => handleNavigation('list')} className="w-full text-left flex items-center px-4 py-2 text-sm text-gray-700 hover:bg-gray-100">
                        <ClipboardListIcon /> Car Listing
                    </button>
